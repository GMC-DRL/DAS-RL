...
from utils.logger.base import LOG_DATA_TYPE, BaseLogger
...
class TensorboardLogger(BaseLogger):
    ...
    def write_together(self, step_type: str, step: int, data: LOG_DATA_TYPE) -> None:
        self.writer.add_scalars(step_type, data, global_step=step)
        self.writer.flush()

    def plot(self, step_type: str, step: int, data: LOG_DATA_TYPE) -> None:
        self.writer.add_figure(step_type, data, global_step=step)
        self.writer.flush()
